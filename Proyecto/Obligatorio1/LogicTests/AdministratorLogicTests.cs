...
public class AdministratorLogicTests
{
    ...
    public void TestInitialize()
    {
        ...
        _booking = new Booking(false, new DateTime(2023, 7, 5), new DateTime(2026, 8, 15), new StorageUnit("12", AreaType.A, SizeType.Small, true, _promotions, _availableDates), "", "Reservado", false);
        ...
        _bookingDto = new BookingDto(false, new DateTime(2023, 7, 5), new DateTime(2026, 8, 15), new StorageUnitDto("12", AreaType.A, SizeType.Small, true, _promotionsDto, _availableDatesDto), "", "Reservado", false);
    ...
    {   
        _administratorLogic.ApproveBooking(_userDto, _bookingDto);
        _bookingDto = new BookingDto(true, new DateTime(2023, 7, 5), new DateTime(2026, 8, 15), new StorageUnitDto("12", AreaType.A, SizeType.Small, true, _promotionsDto, _availableDatesDto), "", "Reservado", false);
        _administratorLogic.ApproveBooking(_userDto, _bookingDto);
    }
    ...
    public void WhenAdministratorAlreadyRejectedABookingShouldThrowException()
    {
        ...
        _bookingDto = new BookingDto(true, new DateTime(2023, 7, 5), new DateTime(2026, 8, 15), new StorageUnitDto("12", AreaType.A, SizeType.Small, true, _promotionsDto, _availableDatesDto), "Rejected", "Reservado", false);
        _administratorLogic.SetRejectionMessage(_userDto, _bookingDto, "Rejected");
    }
}